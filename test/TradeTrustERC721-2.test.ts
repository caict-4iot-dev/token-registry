...
import { expect } from ".";
import { deployEscrowFactoryFixture, deployTokenFixture, mintTokenFixture } from "./fixtures";
...
describe.only("TradeTrustERC721", async () => {
  let users: TestUsers;
  ...
  describe.only("Registry Operation Behaviours", () => {
    ...
    describe("Burn Token", () => {
      describe("When token has been surrendered", () => {
        ...
        it.skip("should emit TokenBurnt event", async () => {});
